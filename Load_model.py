    ...
    if args.task=='denoise':
        if args.val:
            if args.emg_only:
                ...
                #train_paths = get_filepaths(f'{args.train_path}/Noisy_blk','.pt')
                train_paths = get_filepaths(f'{args.train_path}/Noisy','.pt')
                
            #val_paths = get_filepaths(f'{args.train_path}/val_blk','.pt')
            val_paths = get_filepaths(f'{args.train_path}/val','.pt')  
            #train_paths = get_filepaths(f'{args.train_path}/Noisy2','.pt') 
            #val_paths = get_filepaths(f'{args.train_path}/val','.pt')
        else:
            filepaths = get_filepaths(f'{args.train_path}/Noisy2','.pt') 
